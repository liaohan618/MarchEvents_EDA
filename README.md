...
This jupyter notebook explores all the variables from this table to enhance a better understanding of this dataset.

1. General distributions of events
- there are total of 148 unique events
3. Distributions of Factuality and Temporality
4. Detected Participant
- Participant rate for each event
4. Distribution of Language
5. Correlations between events
- distribution : more are less correlated
- focus on > 0.5
